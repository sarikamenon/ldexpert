...
- **Keep files small and focused**: Hard cap of 300 lines per PHP file, 300 lines per JS file. If approaching the limit, extract to smaller classes, view components, dedicated services, or JS modules. No exceptions without a comment justifying and a follow-up task to split.
