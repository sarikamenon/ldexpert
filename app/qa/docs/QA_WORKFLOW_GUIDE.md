...
Step 3: Run Tests (php artisan dusk)
         ↓
Step 4: Get Report (app/qa/reports/)
```
...
### **Location:** `app/qa/LD-Expert-QA.xlsx`
...
See `app/qa/docs/TEST_CASES_CORE_FLOW.md` for all 12 test cases ready to copy.
...
**What it does:**
1. Reads `app/qa/LD-Expert-QA.xlsx`
...
open app/qa/reports/dusk-2026-06-10-153045.html
```
...
# (See app/qa/docs/TEST_CASES_CORE_FLOW.md for template)

# Step 2: Enter test cases in app/qa/LD-Expert-QA.xlsx
# (12 test cases total)
...
# Step 6: View results
open app/qa/reports/dusk-[timestamp].html
```
...
# View latest report
open app/qa/reports/dusk-*.html  # On Mac
...
```
1. Write test cases in Excel (app/qa/LD-Expert-QA.xlsx)
2. Run /qa-generate-tests (generates PHP test files)
3. Run php artisan dusk tests/BrowserQA/ (executes tests)
4. View report in app/qa/reports/ (see results)

That's it!
```

**For your 12 test cases:**
- Copy from `app/qa/docs/TEST_CASES_CORE_FLOW.md`
- Enter into Excel
