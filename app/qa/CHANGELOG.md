...
- **App Version:** v1.0.0+
- **Source:** `app/qa/therapist/test-plan.md`, `app/qa/LD-Expert-QA.xlsx` — Therapist sheet
- **Status:** ✅ Generated & Passing
...
- **App Version:** v1.0.0+
- **Source:** `app/qa/student/test-plan.md`, `app/qa/LD-Expert-QA.xlsx` — Student sheet
- **Status:** ✅ Generated & Passing
...
- **App Version:** v1.0.0+
- **Source:** `app/qa/finance/test-plan.md`, `app/qa/LD-Expert-QA.xlsx` — Finance sheet
- **Status:** ✅ Generated & Passing
...
- **App Version:** v1.0.0+
- **Source:** `app/qa/e2e/` folder, `app/qa/LD-Expert-QA.xlsx` — E2E sheet
- **Status:** ✅ Generated & Passing
...
- [ ] Update `app/qa/admin/test-plan.md` with SSA & contract sections
- [ ] Create `app/qa/admin/contracts-test-plan.md`
- [ ] Add timezone test strategy to `app/qa/SETUP.md`
- [ ] Update `app/qa/LD-Expert-QA.xlsx` with new sheets
...
1. **Update `app/qa/LD-Expert-QA.xlsx`**
...
2. **Update corresponding `app/qa/{role}/test-plan.md`**
...
5. **Run tests & document results**
   ```bash
   /qa-{role}
   # Results in: app/qa/reports/{role}-YYYY-MM-DD-HHMM.md
   ```

6. **Commit both files**
   - `app/qa/LD-Expert-QA.xlsx` (updated test plan)
   - `app/qa/CHANGELOG.md` (this file)
...
- [`app/qa/LD-Expert-QA.xlsx`](./LD-Expert-QA.xlsx) — Master test plan (Excel)
- [`app/qa/admin/test-plan.md`](./admin/test-plan.md) — Admin feature areas
- [`app/qa/therapist/test-plan.md`](./therapist/test-plan.md) — Therapist feature areas
- [`app/qa/student/test-plan.md`](./student/test-plan.md) — Student feature areas
- [`app/qa/finance/test-plan.md`](./finance/test-plan.md) — Finance feature areas
- [`app/qa/SETUP.md`](./SETUP.md) — QA framework setup & dependencies
