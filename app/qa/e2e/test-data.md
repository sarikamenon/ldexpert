...
> Used by: app/qa/LD-Expert-QA.xlsx — E2E sheet (TC-E001–TC-E018)
...
- Existing per-workflow specs live in `app/qa/e2e/*.md` (student-journey, therapist-session-to-billing, admin-audit-flow).
