...
```
**Output:**
- app/qa/finance/test-plan.md
- app/qa/finance/test-data.md
...
```
**Output:**
- app/qa/therapist/test-plan.md
- app/qa/therapist/test-data.md
...
```
**Output:**
- app/qa/student/test-plan.md
- app/qa/student/test-data.md
...
```
**Output:**
- app/qa/e2e/test-data.md
- app/qa/e2e/{workflow-name}.md files
...
2. Re-run the same command, e.g.:
   ...
   /qa-create-scenarios (Role: admin)
   ```
3. The skill runs **Pass 0 (Existing Coverage Diff)** first — it reads the `Feature` column already in `app/qa/LD-Expert-QA.xlsx`, skips every feature already covered, and generates cases **only for the new feature**, continuing the TC ID sequence (e.g. `TC-A088` onward). No duplicates.
...
|------|------------|-----------|-----------|
| Admin | Admin | app/qa/admin/test-plan.md | app/qa/admin/test-data.md |
| Therapist | Therapist | app/qa/therapist/test-plan.md | app/qa/therapist/test-data.md |
| Student | Student | app/qa/student/test-plan.md | app/qa/student/test-data.md |
| Finance | Finance | app/qa/finance/test-plan.md | app/qa/finance/test-data.md |
| E2E | E2E | app/qa/e2e/test-data.md | app/qa/e2e/{workflow-name}.md |
...
- **Excel file required** — Must have `app/qa/LD-Expert-QA.xlsx` with sheets: Admin, Therapist, Student, Finance, E2E
