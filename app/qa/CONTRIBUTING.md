...
1. **Add a row** to `app/qa/LD-Expert-QA.xlsx` with test details
...
- **Read Access:**
  - [`app/qa/LD-Expert-QA.xlsx`](./LD-Expert-QA.xlsx) — Master test plan
  - [`app/qa/CHANGELOG.md`](./CHANGELOG.md) — Version history
...
- **Write Access:**
  - `app/qa/LD-Expert-QA.xlsx` (add rows)
  - `app/qa/CHANGELOG.md` (document additions)
...
Open `app/qa/LD-Expert-QA.xlsx` and add test case rows to the appropriate sheet.
...
**What happens:**
1. Reads `app/qa/LD-Expert-QA.xlsx` (all sheets)
...
**If tests fail:**
1. Check the HTML report in `app/qa/reports/`
...
Document your addition in `app/qa/CHANGELOG.md`:
...
- **Source:** `app/qa/{role}/test-plan.md`, `app/qa/LD-Expert-QA.xlsx` — {Sheet} sheet
...
- **App Version:** v1.0.0+
- **Source:** `app/qa/admin/test-plan.md`, `app/qa/LD-Expert-QA.xlsx` — Admin sheet
...
```bash
git add app/qa/LD-Expert-QA.xlsx app/qa/CHANGELOG.md
...
- Updated app/qa/LD-Expert-QA.xlsx (Admin sheet)
- Updated app/qa/CHANGELOG.md with Entry 1.0.6
...
- [ ] Both files committed: `app/qa/LD-Expert-QA.xlsx` + `app/qa/CHANGELOG.md`
...
Refer to:
- **Framework setup:** [`app/qa/SETUP.md`](./SETUP.md)
- **Test strategy:** [`app/qa/TEST_PLAN.docx`](./TEST_PLAN.docx)
...
| File | Purpose |
|------|---------|
| `app/qa/LD-Expert-QA.xlsx` | Master test plan (rows = tests) |
| `app/qa/CHANGELOG.md` | Version history & test additions |
| `app/qa/SETUP.md` | Framework dependencies & setup |
| `app/qa/{role}/test-plan.md` | Feature area breakdown (Admin, Therapist, Student, Finance) |
| `app/qa/{role}/test-data.md` | Test data requirements & setup |
