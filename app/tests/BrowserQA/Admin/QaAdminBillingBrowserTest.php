...
it('TC-A080 Admin can create an invoice for a school', function (): void {
    ...
    $this->browse(function (Browser $browser) use ($admin, $school): void {
        ...
        // x-ui::select is a custom component; set value via JS, then trigger change.
        // script() returns an array (JS results), so it must NOT be chained.
        $browser->script("document.querySelector('#school_id').value = '{$school->id}'; document.querySelector('#school_id').dispatchEvent(new Event('change'))");
...
it('TC-A081 Admin can view invoice list', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A082 Admin can view invoice details', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A083 Admin can view invoice details page', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A084 Admin can send invoice to school', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A085 Admin can download invoice PDF', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A086 Admin can attach sessions to invoice', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A087 Admin can create a therapist bill', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A088 Admin can view therapist bills list', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A089 Admin can view therapist bill details', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A090 Admin can send therapist bill', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A091 Admin can delete a therapist bill draft', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A092 Admin can attach sessions to therapist bill', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A093 Admin can view finance dashboard', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A094 Finance dashboard displays key metrics', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A095 Admin can record invoice payment', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A096 Admin can view payments list', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A097 Admin can access billing settings', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A098 Admin can update billing settings', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A099 Admin can view ledger accounts', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A100 Admin can view account transactions', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A101 Admin can view billing schedules', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
...
it('TC-A102 Admin can create a billing schedule', function (): void {
    $admin = User::where('email', 'develop.ldexpert@gmail.com')->firstOrFail();
