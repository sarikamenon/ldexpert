/**
 * Shared inline SVG icon helpers.
 *
 * Each function takes a Tailwind class string (e.g. 'w-4 h-4') and returns
 * an inline SVG markup string. Strokes use `currentColor` so the colour is
 * controlled via the surrounding `text-*` class.
 *
 * Add new icons here when they need to be reused across files; one-off icons
 * can stay inline at the call site.
 */

export function clockIcon(cls = 'w-4 h-4') {
...
export function mailIcon(cls = 'w-4 h-4') {
...
export function phoneIcon(cls = 'w-4 h-4') {
...
export function schoolIcon(cls = 'w-4 h-4') {
...
export function userIcon(cls = 'w-4 h-4') {
...
export function peopleIcon(cls = 'w-4 h-4') {
...
export function docIcon(cls = 'w-4 h-4') {
...
export function externalIcon(cls = 'w-4 h-4') {
...
export function videoIcon(cls = 'w-4 h-4') {
