...
function initServiceRows() {
    const tableBody = document.querySelector('#therapistContractServicesTable tbody');
    const addButton = document.getElementById('addTherapistServiceRow');
    const template = document.getElementById('therapistServiceRowTemplate');
