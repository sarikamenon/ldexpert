                    ...
                    html += `
                        <div class="bg-background/subtle rounded-lg p-4">
                            ...
                            <div class="space-y-2.5 text-sm">
                                ...
                                <div><div class="text-foreground/70 mb-1">Hours & Status</div><div class="text-foreground font-medium">THO: ${schedule.ssa.tho_minutes != null ? (schedule.ssa.tho_minutes / 60).toFixed(2) : '0'}</div><div class="text-foreground font-medium">Served: ${schedule.ssa.served_minutes != null ? (schedule.ssa.served_minutes / 60).toFixed(2) : '0'}</div><div class="text-foreground font-medium">Status: ${schedule.ssa.status ? schedule.ssa.status.toUpperCase() : '-'}</div></div>
                            </div>
                        </div>
                    `;
                }
