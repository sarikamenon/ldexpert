...
<head>
    ...
    <title>SSA Import Completed</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td style="padding:28px 28px 12px 28px;">
                <h1 style="margin:0; font-size:22px; color:#0f172a;">SSA Import Completed</h1>
            </td>
        </tr>
        <tr>
            <td style="padding:8px 28px 0 28px; line-height:1.5; color:#475569;">
                <p style="margin:0 0 16px;">
                    Your SSA import (Import #{{ $import->id }}) has been completed.
                </p>
                ...
                <a href="{{ config('app.url') }}/admin/ssas/imports/{{ $import->id }}"
