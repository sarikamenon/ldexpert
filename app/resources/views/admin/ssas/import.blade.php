<x-admin.layouts.app>
    <x-page-title title="Import SSAs" />
    ...
    <x-ui::card class="p-6 space-y-6">
        <div>
            <h2 class="text-xl font-semibold mb-2">Import SSAs from CSV</h2>
            <p class="text-sm text-foreground/60">
                Upload a CSV file containing SSA information. The file must include all required columns.
                Duplicate SSAs (overlapping date ranges for same student and service) will be skipped automatically.
        ...
        <div id="templateInfo" class="bg-foreground/5 rounded-lg p-4 space-y-3">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.ssas.import.template', ['type' => 'NOVA']) }}" id="templateDownloadLink"
        ...
        {{-- Import Form --}}
        <form id="importForm" method="POST" action="{{ route('admin.ssas.import.store') }}"
            ...
            <div>
                ...
                <input type="file" id="file" name="file" accept=".csv,.txt"
                    class="mt-1 block w-full text-sm text-foreground file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-white hover:file:bg-primary/90"
    ...
    <x-slot name="scripts">
        @vite(['resources/js/pages/admin-ssas-import.js'])
    </x-slot>
</x-admin.layouts.app>
