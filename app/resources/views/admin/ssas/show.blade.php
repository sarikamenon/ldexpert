<x-admin.layouts.app>
    ...
    <div x-data="{ activeTab: 'details' }">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-border">
                        <tbody class="bg-background divide-y divide-border">
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70 w-1/3">SSA
                                    ID</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">#{{ $ssa->id }}
                                </td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">Student
                                </td>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">School
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">
                                    @if ($ssa->student?->studentProfile?->school)
                                        <a href="{{ route('admin.schools.show', $ssa->student->studentProfile->school) }}"
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">Status
                                </td>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">Start
                                    Date</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">Minutes
                                    per Session</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">Sessions
                                    per Frequency</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">
                                    {{ $ssa->sessions_per_frequency }}</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">THO
                                    Minutes</td>
                            ...
                            @endif
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">Created
                                    At</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">
                                    {{ $ssa->created_at->format('M d, Y g:i A') }}</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">Last
                                    Updated</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">
        ...
        {{-- Assignment Tab --}}
        <div x-show="activeTab === 'assignment'" x-transition>
