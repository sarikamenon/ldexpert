<x-admin.layouts.app>
    ...
    <x-ui::card class="p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-semibold">SSA Import History</h2>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-border display" id="importsTable"
                data-datatable-url="{{ $datatableUrl ?? route('admin.ssas.imports.data') }}">
    ...
    <x-slot name="scripts">
        @vite(['resources/js/pages/admin-ssas-import-history.js'])
    </x-slot>
</x-admin.layouts.app>
