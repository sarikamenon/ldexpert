<x-admin.layouts.app>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-foreground/60 mt-1">
                    ...
                    File: <a href="{{ route('admin.students.imports.download', $import) }}" class="font-medium text-primary hover:underline">{{ $import->file_name }}</a> |
    ...
    <x-slot name="scripts">
        @vite(['resources/js/pages/admin-students-import-status.js'])
    </x-slot>
</x-admin.layouts.app>
