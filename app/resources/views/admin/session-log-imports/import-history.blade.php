<x-admin.layouts.app>
    ...
    <x-page-title title="Session Log Import History" />
    ...
    <x-ui::card class="p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-semibold">Session Log Import History</h2>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-border display" id="importsTable"
                data-datatable-url="{{ $datatableUrl ?? route('admin.session-logs.imports.data') }}">
    ...
    <x-slot name="scripts">
        @vite(['resources/js/pages/admin-session-log-import-history.js'])
    </x-slot>
</x-admin.layouts.app>
