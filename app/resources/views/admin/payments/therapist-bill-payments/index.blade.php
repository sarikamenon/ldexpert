<x-admin.layouts.app>
    ...
    <x-ui::card class="p-6 mb-6">
        <div class="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
            <div>
                ...
                <p class="text-2xl font-bold mt-1" id="therapistBillPaymentsTotalAmount">$0.00</p>
            </div>
            <div>
                <p class="text-sm text-foreground/70">Number of Payments</p>
                <p class="text-2xl font-bold mt-1" id="therapistBillPaymentsCount">0</p>
            </div>
        </div>
    </x-ui::card>
    ...
    <x-ui::card class="p-6 space-y-4 overflow-hidden">
        ...
        <form method="GET" action="{{ route('admin.payments.therapist-bills.index') }}" id="therapistBillPaymentsFiltersForm"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 flex-1">
                <div>
                    ...
                    <p class="mt-1 text-xs text-foreground/60" id="from_date_help">
                        Filter therapist payments from this date onward. Leave blank to include all earlier payments.
                    </p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-foreground/60" id="to_date_help">
                        Filter therapist payments up to and including this date. Leave blank to include recent payments.
                    </p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-foreground/60" id="method_help">
                        Narrow results to payments made with a specific method, such as direct deposit or check.
                    </p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-foreground/60" id="search_help">
                        Search by reference number or therapist name to quickly locate a specific payment.
                    </p>
                    <input type="text" id="search" name="search" value="{{ request('search') }}"
                        placeholder="Reference or Therapist" aria-describedby="search_help"
                        class="mt-1 w-full px-3 py-2 border border-border rounded-md text-sm focus:ring-2 focus:ring-primary focus:outline-none">
                </div>
            </div>
        ...
        <div class="overflow-x-auto">
            <table id="therapistBillPaymentsTable" class="w-full display"
    ...
    <x-slot name="scripts">
        @vite(['resources/js/pages/admin-therapist-bill-payments-index.js'])
    </x-slot>
</x-admin.layouts.app>
