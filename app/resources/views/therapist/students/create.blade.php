<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-foreground">Create Student</h2>
        </div>
    </x-slot>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-ui::input name="middle_name" value="{{ old('middle_name') }}" />
                                @error('middle_name')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-ui::input name="gender" value="{{ old('gender') }}" />
                                @error('gender')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-ui::input name="school" value="{{ old('school') }}" />
                                @error('school')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <x-ui::input name="id_number" value="{{ old('id_number') }}" />
                                @error('id_number')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <x-ui::input name="parent_guardian_name" value="{{ old('parent_guardian_name') }}" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-ui::input type="email" name="parent_guardian_email"
                                    value="{{ old('parent_guardian_email') }}" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <x-ui::input name="zip_code" value="{{ old('zip_code') }}" />
                                @error('zip_code')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
