        ...
        <div class="max-w-7xl mx-auto px-4 lg:px-8">
            ...
            <x-ui::card class="p-6 mb-6">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div>
                        <h1 class="text-2xl font-semibold text-foreground">SSA #{{ $ssa->id }}</h1>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-border">
                            <tbody class="bg-background divide-y divide-border">
                                <tr>
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70 w-1/3">
                                        SSA ID</td>
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">End
                                        Date</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">
                                        Minutes per Session</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground">
                                        {{ number_format($ssa->minutes_per_session) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">
                                        Served Minutes</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground font-semibold">
                                        {{ number_format($ssa->served_minutes) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground/70">
                                        Remaining Minutes</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-foreground font-semibold">
