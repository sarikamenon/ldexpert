...
<x-ui::card class="p-6 space-y-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex space-x-1">
                                    ...
                                    <button type="button"
                                        class="therapist-contract-status-toggle inline-flex items-center justify-center w-8 h-8 rounded transition-colors {{ $contract->status === \App\Enums\ContractStatus::ACTIVE ? 'bg-danger text-danger-foreground hover:bg-danger/90' : 'bg-success text-success-foreground hover:bg-success/90' }}"
    ...
    @else
        <div class="text-center py-10">
            <p class="text-foreground/70 mb-4">No contracts found.</p>
            <a href="{{ route('admin.contracts.therapists.create') }}"
                class="inline-flex items-center px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 text-sm font-medium">
                Add Contract
            </a>
