...
final class TherapistSSARowTransformer
{
    ...
    public static function transform(ServiceSupportAgreement $ssa): array
    {
        ...
        $actionsCell = '<div class="flex items-center gap-2">'
            .'<a href="'.e($showUrl).'" class="inline-flex items-center justify-center w-9 h-9 bg-secondary text-white rounded hover:bg-secondary/90 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring" title="View SSA" aria-label="View SSA '.(int) $ssa->id.'">'
            .$viewIcon
            .'</a>'
            .'</div>';
