...
final class BillingSettingsDTO
{
    public function __construct(
        ...
        public readonly int $advanceDefaultMinGraceDays,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            advanceDefaultMinGraceDays: (int) ($data['advance_default_min_grace_days'] ?? 2),
    ...
    public function toArray(): array
    {
        return [
            ...
            'advance_default_min_grace_days' => $this->advanceDefaultMinGraceDays,
