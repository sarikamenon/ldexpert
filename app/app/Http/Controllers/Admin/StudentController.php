...
final class StudentController extends Controller
{
    ...
    public function data(StudentDataRequest $request): JsonResponse
    {
        ...
        $data = $result['rows']->map(function (User $student): array {
            return $this->studentRowToDataTablesRow($student);
        })->all();
     ...
     */
    private function studentRowToDataTablesRow(User $student): array
    {
