...
final class StoreBillingScheduleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_terms_days' => ['required', 'integer', $this->input('billing_mode') === BillingMode::ADVANCE->value ? 'min:0' : 'min:1', 'max:90'],
