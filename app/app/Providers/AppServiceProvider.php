...
use App\Infrastructure\Repositories\EloquentBillingScheduleRepository;
...
use App\Infrastructure\Repositories\EloquentInvoiceLineItemRepository;
...
use App\Infrastructure\Repositories\EloquentScheduleMakeupAvailabilityRepository;
use App\Infrastructure\Repositories\EloquentScheduleMakeupRequestRepository;
use App\Infrastructure\Repositories\EloquentScheduleRepository;
use App\Infrastructure\Repositories\EloquentScheduleSubRequestRepository;
...
use App\Infrastructure\Repositories\EloquentServiceAliasRepository;
use App\Infrastructure\Repositories\EloquentServiceRepository;
use App\Infrastructure\Repositories\EloquentSessionLogImportRepository;
...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(ServiceAliasRepositoryInterface::class, EloquentServiceAliasRepository::class);
        ...
        $this->app->bind(SSAGoalRepositoryInterface::class, EloquentSSAGoalRepository::class);
        $this->app->bind(ScheduleRepositoryInterface::class, EloquentScheduleRepository::class);
        $this->app->bind(ScheduleSubRequestRepositoryInterface::class, EloquentScheduleSubRequestRepository::class);
        $this->app->bind(ScheduleMakeupRequestRepositoryInterface::class, EloquentScheduleMakeupRequestRepository::class);
        $this->app->bind(ScheduleMakeupAvailabilityRepositoryInterface::class, EloquentScheduleMakeupAvailabilityRepository::class);
        $this->app->bind(SessionLogRepositoryInterface::class, EloquentSessionLogRepository::class);
        $this->app->bind(SessionLogImportRepositoryInterface::class, EloquentSessionLogImportRepository::class);
        $this->app->bind(InvoiceRepositoryInterface::class, EloquentInvoiceRepository::class);
        $this->app->bind(TherapistBillRepositoryInterface::class, EloquentTherapistBillRepository::class);
        $this->app->bind(BillingScheduleRepositoryInterface::class, EloquentBillingScheduleRepository::class);
        $this->app->bind(InvoiceLineItemRepositoryInterface::class, EloquentInvoiceLineItemRepository::class);
