...
use App\Policies\SessionLogImportPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router): void
    {
        ...
        Gate::policy(SessionLogImport::class, SessionLogImportPolicy::class);
        Gate::policy(Invoice::class, InvoicePolicy::class);
        Gate::policy(BillingSchedule::class, BillingSchedulePolicy::class);
