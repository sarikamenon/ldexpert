    ...
    'templates' => [
        'NOVA' => [
            ...
            'column_mapping' => [
                ...
                'parent_guardian_2_name' => 'parent_guardian_2_name',
                'parent_guardian_2_email' => 'parent_guardian_2_email',
                'parent_guardian_2_phone' => 'parent_guardian_2_phone',
            ],
        ],
        ...
        'TUTORBIRD' => [
            ...
            'column_mapping' => [
                ...
                'Parent Contact 2 Last Name' => 'parent_guardian_2_last_name',
                'Parent Contact 2 First Name' => 'parent_guardian_2_first_name',
                'Parent Contact 2 Email' => 'parent_guardian_2_email',
                'Parent Contact 2 Mobile Phone' => 'parent_guardian_2_phone',
                'School' => 'school_name',
            ],
            'field_sources' => [
                'email' => 'parent_guardian_email',
            ...
            'transformations' => [
                ...
                [
                    'type' => 'combine',
                    'target' => 'parent_guardian_2_name',
                    'sources' => ['parent_guardian_2_first_name', 'parent_guardian_2_last_name'],
                    'separator' => ' ',
                ],
            ],
        ],
