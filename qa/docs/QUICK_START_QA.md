...
**File:** `qa/docs/TEST_CASES_CORE_FLOW.md`
...
**Location:** `qa/reports/dusk-2026-06-10-HHMMSS.html`
...
TEST_CASES_CORE_FLOW.md (read this)
    ↓
Enter test cases in qa/LD-Expert-QA.xlsx
    ↓
...
php artisan dusk tests/BrowserQA/ (runs tests)
    ↓
qa/reports/dusk-[timestamp].html (view results)
    ↓
...
### **Read First:**
```
qa/docs/TEST_CASES_CORE_FLOW.md
...
### **Next Steps**
1. **Read:** `qa/docs/TEST_CASES_CORE_FLOW.md`
2. **Create:** `qa/LD-Expert-QA.xlsx` with test cases
3. **Generate:** `/qa-generate-tests`
4. **Run:** `php artisan dusk tests/BrowserQA/`
5. **Review:** `qa/reports/[latest].html`
...
**For detailed guide:** `qa/docs/QA_WORKFLOW_GUIDE.md`  
**For test cases:** `qa/docs/TEST_CASES_CORE_FLOW.md`  
**For master plan:** `qa/docs/MASTER_PLAN.md`

---

**You're all set! Start with reading `qa/docs/TEST_CASES_CORE_FLOW.md` now.** 🚀
